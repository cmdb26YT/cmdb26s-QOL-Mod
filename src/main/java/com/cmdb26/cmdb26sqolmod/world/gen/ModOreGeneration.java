...
public class ModOreGeneration {
    public static void generateOres(final BiomeLoadingEvent event) {
        //spawnOreInSpecificModBiome(ModBiomes.BIOME.get(), OreType.RUBY, event, Dimension.OVERWORLD.toString());
        //spawnOreInSpecificBiome(Biomes.BIOME, OreType.RUBY, event, Dimension.OVERWORLD.toString());
